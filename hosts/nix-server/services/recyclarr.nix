...
in
{
  age.secrets =
    ...
    {
      sonarrApiKey = {
        file = secrets.getSecret "recyclarr-sonarr-token";
      }
      // ownership;
      radarrApiKey = {
        file = secrets.getSecret "recyclarr-radarr-token";
      }
      // ownership;
    };
  ...
  services.recyclarr = {
    ...
    configuration = {
      sonarr = {
        main_sonarr = {
          api_key = {
            _secret = config.age.secrets.sonarrApiKey.path;
          };
          ...
          custom_formats =
            let
              mkSonarrAssignedProfiles = (mkAssignedProfiles "Remux-1080p - Anime");
      ...
      radarr = {
        main_radarr = {
          ...
          custom_formats =
            let
              mkRadarrAssignedProfiles = (mkAssignedProfiles "Remux-1080p - Anime");
            in
            [
              {
                trash_ids = [
