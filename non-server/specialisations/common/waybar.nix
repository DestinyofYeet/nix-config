    ...
    settings = [
      {
        ...
        modules-right = [
          "inhibitor"
          (lib.mkIf (osConfig.capabilities.battery.enable) "battery")
          "wireplumber"
          (lib.mkIf (osConfig.capabilities.touch.enable) "backlight")
          "temperature"
          # "group/cpu-load"
          "memory"
          # "group/power"
          (lib.mkIf (osConfig.capabilities.bluetooth.enable) "bluetooth")
          "network"
          "tray"
        ];
